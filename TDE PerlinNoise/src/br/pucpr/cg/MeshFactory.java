...
public class MeshFactory {
    ...
    public static Mesh loadTerrain(File file, float scale, float texRepeat) throws IOException {
        ...
        float h = (1/img.getHeight()) * texRepeat;
        float w = (1/img.getWidth()) * texRepeat;
